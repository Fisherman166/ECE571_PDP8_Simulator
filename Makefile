...
WORK__TestBench002 = $(LIB_WORK)/_lib.qdb
...
$(LIB_WORK)/_lib.qdb : src/Top.sv testbenches/TestBench002.sv src/Multiply.sv \
	...
	$(VLOG) -sv -source -mfcu src/Controller.sv \
		 ...
		 src/memory_utils.pkg testbenches/TestBench002.sv \
